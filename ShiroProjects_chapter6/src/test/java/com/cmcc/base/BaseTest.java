...
import com.cmcc.service.PermissionServiceImpl;
import com.cmcc.service.RoleService;
import com.cmcc.service.RoleServiceImpl;
...
public abstract class BaseTest {
    ...
    public void setUp() {
        ...
        //3、关联角色-权限
        roleService.uncorrelationPermissions(r1.getId(), p1.getId());
        roleService.uncorrelationPermissions(r1.getId(), p2.getId());
        roleService.uncorrelationPermissions(r1.getId(), p3.getId());

        roleService.uncorrelationPermissions(r2.getId(), p1.getId());
        roleService.uncorrelationPermissions(r2.getId(), p2.getId());
